...
glutSolidCube(40);  // Mengganti dengan kubus
...
void glShadowProjection(float * l, float * e, float * n)
{
  ...
  mat[4]  = n[1]*l[0];         // menggunakan kolom matrik
  mat[8]  = n[2]*l[0];
  mat[12] = -l[0]*c-l[0]*d;
  ...
  glMultMatrixf(mat);         // kalikan matrix
}
...
void help()
{
  printf("proyeksi contoh bayangan sebuah obyek kubus\n");
}
...
int main(int argc, char * argv[])
{
  ...
  glutCreateWindow("NO 2 - proyeksi bayangan");
